...
{
    /// <summary>
    /// Represents a memory mapped huge array of ints.
    /// </summary>
    public class MemoryMappedHugeArrayInt64 : MemoryMappedHugeArray<long>
    {
        ...
        public MemoryMappedHugeArrayInt64(MemoryMappedFile file, long size)
            : base(file, 8, size, DefaultFileElementSize, (int)DefaultFileElementSize / DefaultBufferSize, DefaultCacheSize)
        {
        ...
        public MemoryMappedHugeArrayInt64(MemoryMappedFile file, long size, long arraySize)
            : base(file, 8, size, arraySize, (int)arraySize / DefaultBufferSize, DefaultCacheSize)
        {
        ...
        public MemoryMappedHugeArrayInt64(MemoryMappedFile file, long size, long arraySize, int bufferSize)
            : base(file, 8, size, arraySize, bufferSize, DefaultCacheSize)
        {
        ...
        public MemoryMappedHugeArrayInt64(MemoryMappedFile file, long size, long arraySize, int bufferSize, int cacheSize)
            : base(file, 8, size, arraySize, bufferSize, cacheSize)
        {
        ...
        /// <returns></returns>
        protected override MemoryMappedAccessor<long> CreateAccessor(MemoryMappedFile file, long sizeInBytes)
        {
            return file.CreateInt64(sizeInBytes);
        }
    }
}
