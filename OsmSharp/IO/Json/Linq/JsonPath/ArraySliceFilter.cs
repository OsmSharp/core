        ...
        public override IEnumerable<JToken> ExecuteFilter(IEnumerable<JToken> current, bool errorWhenNoMatch)
        {
            ...
            foreach (JToken t in current)
            {
                ...
                if (a != null)
                {
                    ...
                    startIndex = System.Math.Max(startIndex, (stepCount > 0) ? 0 : int.MinValue);
                    startIndex = System.Math.Min(startIndex, (stepCount > 0) ? a.Count : a.Count - 1);
                    stopIndex = System.Math.Max(stopIndex, -1);
                    stopIndex = System.Math.Min(stopIndex, a.Count);
